...
class EDIParser():
    ...
    def create_contrl(self, segments=None) -> [Segment]:
        ...
        hash_string = '{}:{}'.format(
            segment_hash, unix_timestamp).encode('utf-8')
        ...
        unb['interchange_sender'] = [self.our_ediel_id,
                                     partner_identification_code_qualifier]
        unb['interchange_recipient'] = [RECIPIENT_EDIEL_ID,
                                        partner_identification_code_qualifier]
    ...
    def create_aperak(self, segments=None) -> [Segment]:
        ...
        timestamp_now = edi.format_timestamp(datetime.now())
        partner_identification_code_qualifier = segments['UNB'][
            'interchange_sender']['partner_identification_code_qualifier'].value
        ...
        nad1['party_identification_details'] = [
            self.our_ediel_id, 'SVK', '260']
    ...
    def toMail(self, segments=None, send_from=None, send_to=None, subject=None, filename=None):
        ...
        mail.add_header('Content-Disposition',
                        'attachment; filename="{}"'.format(EDI_FILENAME))
